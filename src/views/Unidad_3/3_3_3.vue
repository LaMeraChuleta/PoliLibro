<template>
  <div class="max-w-6xl mx-auto p-6 space-y-8">
    ...
    <header class="border-b border-gray-200 pb-4">
      <h1 class="text-3xl font-bold text-gray-800">Capítulo 3.3.3: Algoritmos de Camino Corto</h1>
...
const preguntas = [
  {
    texto: "¿Cuál es la complejidad temporal del algoritmo de Dijkstra usando un heap binario?",
    opciones: [
      { letra: "A", texto: "O(V²)", correcta: false },
      { letra: "B", texto: "O(V log V + E log V)", correcta: true },
      { letra: "C", texto: "O(V + E)", correcta: false },
      { letra: "D", texto: "O(V³)", correcta: false }
    ],
    respuestaCorrecta: "B",
    explicacion: "Con heap binario, cada operación de inserción/extracción es O(log V), y hay O(V + E) operaciones."
  },
  {
    texto: "¿Por qué el algoritmo de Dijkstra no funciona con pesos negativos?",
    opciones: [
      { letra: "A", texto: "Porque usa programación dinámica", correcta: false },
      { letra: "B", texto: "Porque asume que una vez procesado un vértice, su distancia es definitiva", correcta: true },
      { letra: "C", texto: "Porque requiere grafos no dirigidos", correcta: false },
      { letra: "D", texto: "Porque usa búsqueda en profundidad", correcta: false }
    ],
    respuestaCorrecta: "B",
    explicacion: "Dijkstra asume que la distancia mínima a un vértice es definitiva cuando se extrae del heap, lo cual no es cierto con pesos negativos."
  },
  {
    texto: "¿Cuál es la principal ventaja del algoritmo de Bellman-Ford sobre Dijkstra?",
    opciones: [
      { letra: "A", texto: "Es más rápido para grafos densos", correcta: false },
      { letra: "B", texto: "Puede manejar pesos negativos y detectar ciclos negativos", correcta: true },
      { letra: "C", texto: "Requiere menos memoria", correcta: false },
      { letra: "D", texto: "Es más fácil de implementar", correcta: false }
    ],
    respuestaCorrecta: "B",
    explicacion: "Bellman-Ford puede manejar pesos negativos y detectar ciclos negativos, aunque es más lento que Dijkstra."
  }
]
