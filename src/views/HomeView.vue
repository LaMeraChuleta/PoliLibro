<template>
  <!-- NAVBAR -->
  <header class="w-full bg-white border-b border-gray-200 shadow-sm fixed top-0 left-0 right-0 z-30">
  ...
  <div class="flex bg-gray-100 min-h-screen pt-14">

    <!-- SIDEBAR -->
    <aside
      ref="sidebarRef"
      class="bg-white w-64 border-r border-gray-200 shadow-lg
...
=======
    ...
    >
      <div class="max-w-6xl mx-auto">
        <!-- Indicador de unidad actual -->
        <div v-if="activeTema !== null" class="mb-6">
          <div class="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-700">
            <div class="w-6 h-6 rounded-full bg-blue-500 text-white flex items-center justify-center mr-2 text-sm font-bold">
              {{ activeTema + 1 }}
            </div>
            <span class="font-medium">Unidad {{ activeTema + 1 }}: {{ temario[activeTema] }}</span>
          </div>
        </div>
