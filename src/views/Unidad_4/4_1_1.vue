  ...
  <div class="container mx-auto px-4 py-6 space-y-8">
    ...
    <section class="bg-blue-50 p-6 rounded-lg">
      ...
      <p class="text-gray-700 leading-relaxed">
        Un Árbol Binario de Búsqueda (ABB) es una estructura de datos en forma de árbol donde cada nodo tiene como máximo dos hijos (izquierdo y derecho), 
        y mantiene una propiedad de orden: para cada nodo, todos los valores en el subárbol izquierdo son menores, 
        y todos los valores en el subárbol derecho son mayores. Esta propiedad permite realizar operaciones de búsqueda, 
    ...
    <section>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-white border border-gray-200 rounded-lg p-5 shadow-sm">
          ...
          <p class="text-gray-600 text-sm">Para cada nodo: izquierdo ≤ nodo ≤ derecho. Base de todas las operaciones eficientes.</p>
        </div>
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-5 shadow-sm">
          ...
          <p class="text-gray-600 text-sm">Diccionario ordenado: palabras con definiciones, ordenadas alfabéticamente para búsqueda rápida.</p>
        </div>
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-5 shadow-sm">
          ...
          <p class="text-gray-600 text-sm">No es un árbol binario común. La propiedad de orden es lo que permite búsquedas eficientes.</p>
        </div>
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-5 shadow-sm">
          ...
          <p class="text-gray-600 text-sm">Los ABB pueden degenerar en listas enlazadas (O(n)) si se insertan valores ordenados.</p>
        </div>
      </div>
    </section>
    ...
    <section class="space-y-10">
      ...
      <div>
        ...
        <p class="text-gray-600 mb-4">Implementación de la clase Nodo y funciones básicas para manipular un árbol binario de búsqueda.</p>
      ...
      <div>
        ...
        <p class="text-gray-600 mb-4">Operaciones fundamentales: agregar nuevos valores y verificar existencia de valores.</p>
        <PythonRunner :code="ejemplo2Code" />
      </div>

      <!-- Ejemplo 3 -->
      <div>
        <h3 class="text-lg font-semibold text-gray-700 mb-3">3. Recorridos en ABB (inorden, preorden, postorden)</h3>
        <p class="text-gray-600 mb-4">Diferentes formas de recorrer un árbol binario de búsqueda y sus aplicaciones.</p>
    ...
    <section class="border border-gray-300 rounded-xl p-6 bg-gray-50">
      ...
      <div class="space-y-4">
        <p class="text-gray-700">
          <strong>Enunciado:</strong> Implementa una función <code>es_abb_valido</code> que verifique si un árbol binario 
          cumple con la propiedad de árbol binario de búsqueda. La función debe retornar True si el árbol es un ABB válido 
